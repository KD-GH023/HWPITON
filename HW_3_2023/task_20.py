...
engl = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 8:'JZ', 10:'QZ'}
russ = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ', 3:'БГЁЬЯ', 4:'ЙЫ', 5:'ЖЗХЦЧ', 8:'ШЭЮ', 10:'ФЩЪ'}
text = input('Ввести слово: ').upper()
if isCyrillic(text):
	print(sum([k for i in text for k, v in russ.items() if i in v]))
else:
	print(sum([k for i in text for k, v in engl.items() if i in v]))